...
/**
 * Read-only Spring Data JPA repository for the HMS {@code prescriptions} table.
 *
 ...
 */
public interface HmsPrescriptionRepository extends JpaRepository<Prescription, Long> {

    /**
     * Retrieves all prescriptions for a given patient.
     *
     * @param patientId the patient's primary key
     * @return a list of prescriptions (may be empty)
     */
